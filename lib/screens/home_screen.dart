                          ...
                          child: SfCartesianChart(
                            ...
                            primaryYAxis: NumericAxis(
                              ...
                              labelStyle: TextStyle(
                                  color:
                                      AppColors.kSecondayColor.withOpacity(.5)),
                            ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: SfCartesianChart(
                        ...
                        tooltipBehavior: TooltipBehavior(enable: true),
                        series: <SplineSeries<VPNData, String>>[
                          SplineSeries<VPNData, String>(
                            dataSource: _gpuOrangeData, // Orange line data
                            xValueMapper: (VPNData sales, _) => sales.yData,
                            yValueMapper: (VPNData sales, _) => sales.xData,
                            color: Colors.green, // Orange line color
                            width: 2,
                            dataLabelSettings:
                                DataLabelSettings(isVisible: false),
                          ),
                          SplineSeries<VPNData, String>(
                            dataSource: _gpuGreenData, // Green line data
                            xValueMapper: (VPNData sales, _) => sales.yData,
                            yValueMapper: (VPNData sales, _) => sales.xData,
                            color: Colors.orange, // Green line color
                            width: 2,
                            dataLabelSettings:
                                DataLabelSettings(isVisible: false),
                          ),
